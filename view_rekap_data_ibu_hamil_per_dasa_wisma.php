            ...
            <table class="table table-hover table-striped table-bordered" id="table-default">
                <thead class="table-light">
                    <tr>
                        ...
                        <th scope="col">Nama Ibu HMN</th>
                        <th scope="col">Nama Suami HMN</th>
                        <th scope="col">Hamil Status</th>
                        <th scope="col">Melahirkan Status</th>
                        <th scope="col">Nifas Status</th>
                        <th scope="col">Nama Bayi ML</th>
                        <th scope="col">Jenis Kelamin ML</th>
                        <th scope="col">Tempat Lahir</th>
                        <th scope="col">Tanggal Lahir</th>
                        <th scope="col">Akte Kelahiran</th>
                        <th scope="col">Nama Ibu MT</th>
                        <th scope="col">Nama Bayi MT</th>
                        <th scope="col">Nama Balita</th>
                        <th scope="col">Jenis Kelamin MT</th>
