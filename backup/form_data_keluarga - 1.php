...
<head>
    ...
    <title>FORM TAMBAH : DATA KELUARGA</title>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $requiredFields = [
            ...
            'kelumur',  'bumil', 'ibumenyusui', 'pasangansubur', 
            'wanitausiasubur', 'buta',  'makananPokok', 'jaminanKeluarga', 
            'jumlahJaminan', 'sumberAir', 'pembuanganSampah', 'pembuanganAirLimbah',
            'stiker', 'kriteriaRumah', 'up2k', 'usahaKesling'
        ];
            ...
            <form method="post" action="">
                ...
                <div class="ctn-form form-section active" id="<?php echo $formTarget1; ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="noreg" name="noreg" placeholder="01.03.003.05.01.03">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <input name="statusdalamkeluarga" type="text" class="form-control" id="statusdalamkeluargaLainnyaText" placeholder="Sebutkan Lainnya" oninput="updateStatusDalamKeluargaLainnya()">
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="umur" name="umur" placeholder="Jawaban Anda">
                    </div>
                    <div class="mb-3">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <input name="pendidikan" type="text" class="form-control" id="pendidikanLainnyaText" placeholder="Sebutkan Lainnya" oninput="updatePendidikanLainnya()">
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <input name="pekerjaan" type="text" class="form-control" id="pekerjaanLainnyaText" placeholder="Sebutkan Lainnya" oninput="updatePekerjaanLainnya()">
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                ...
                <div class="ctn-form form-section" id="<?php echo $formTarget2; ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <input name="makananPokok" type="text" class="form-control" id="makananpokokLainnyaText" placeholder="Sebutkan Lainnya" oninput="updateMakananLainnya()">
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="form-label bold mt-3"><strong>Jika ya, jumlah jaminan keluarga (jika tidak ada, pilih Lainnya dan isi "0")</strong></label>
                        <div class="d-flex flex-column">
                            ...
                            <input name="jumlahJaminan" type="number" class="form-control" id="jumlahLainnyaText" placeholder="Sebutkan Lainnya" oninput="updateJumlahLainnya()">
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="d-flex flex-column"> <!-- Tambahkan kelas ini -->
                            ...
                            <div>
                                ...
                                <input name="sumberAir" type="text" class="form-control" id="sumberAirLainnyaText" placeholder="Sebutkan Lainnya" oninput="updateSumberAirLainnya()">
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="form-label bold mt-3"><strong>10. Aktifitas UP2K</strong></label>
                            ...
                            <div>
                                ...
                                <input name="up2k" type="text" class="form-control" id="up2k_lainnyaText" placeholder="Sebutkan Lainnya" oninput="updateUp2kLainnya()">
                            </div>
                    </div>
                    <div class="mb-3">
