...
<body class="bg-light">
                ...
                <div class="ctn-form form-section active" id="<?php echo $formTarget1; ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="statusdalamperkawinan" name="statusdalamperkawinan">
                            <option value="">Pilih</option>
                            <option value="Menikah" <?php echo ($_SESSION['status_dalam_perkawinan'] == 'Menikah') ? 'selected' : ''; ?>>Menikah</option>
                            <option value="Belum Menikah" <?php echo ($_SESSION['status_dalam_perkawinan'] == 'Belum Menikah') ? 'selected' : ''; ?>>Belum Menikah</option>
                            <option value="Cerai Mati" <?php echo ($_SESSION['status_dalam_perkawinan'] == 'Cerai Mati') ? 'selected' : ''; ?>>Cerai Mati</option>
                            <option value="Cerai Hidup" <?php echo ($_SESSION['status_dalam_perkawinan'] == 'Cerai Hidup') ? 'selected' : ''; ?>>Cerai Hidup</option>
                        </select>
                    </div>
                    <div class="mb-3">
    ...
    <script>
        //ATUR NAVIGASI TOMBOL NEXT/BACK
        ...
        //Fetch data dari ID elemen (khusus form edit)
    ...
    // PENTING! buat init value awal radio lainnya, mencegah value null bocor masuk ke database        
    document.addEventListener('DOMContentLoaded', function() {
        const statusLainnyaText = "<?php echo $_SESSION['status_dalam_keluarga'] ?? ''; ?>";
        if (statusLainnyaText && !['Kepala Keluarga', 'Istri', 'Anak'].includes(statusLainnyaText)) {
            document.getElementById('statusdalamkeluargaLainnyaText').value = statusLainnyaText;
            document.getElementById('statusLainnya').value = statusLainnyaText;
            document.getElementById('statusLainnya').checked = true;
        }

        const pendidikanLainnyaText = "<?php echo $_SESSION['pendidikan_terakhir'] ?? ''; ?>";
        if (pendidikanLainnyaText && !['SD', 'SMP', 'SMA', 'S1', 'S2', 'S3'].includes(pendidikanLainnyaText)) {
            document.getElementById('pendidikanLainnyaText').value = pendidikanLainnyaText;
            document.getElementById('pendidikanLainnya').value = pendidikanLainnyaText;
            document.getElementById('pendidikanLainnya').checked = true;
        }

        const pekerjaanLainnyaText = "<?php echo $_SESSION['pekerjaan'] ?? ''; ?>";
        if (pekerjaanLainnyaText && !['ASN', 'TNI/Polri', 'Pegawai Swasta', 'Wiraswasta', 'Mengurus Rumah Tangga', 'Pelajar', 'Mahasiswa'].includes(pekerjaanLainnyaText)) {
            document.getElementById('pekerjaanLainnyaText').value = pekerjaanLainnyaText;
            document.getElementById('pekerjaanLainnya').value = pekerjaanLainnyaText;
            document.getElementById('pekerjaanLainnya').checked = true;
        }

        const makananLainnyaText = "<?php echo $_SESSION['makanan_pokok_sehari_hari'] ?? ''; ?>";
        if (makananLainnyaText && !['Beras', 'NonBeras'].includes(makananLainnyaText)) {
            document.getElementById('makananpokokLainnyaText').value = makananLainnyaText;
            document.getElementById('makananLainnya').value = makananLainnyaText;
            document.getElementById('makananLainnya').checked = true;
        }

        const jumlahLainnyaText = "<?php echo $_SESSION['jumlah_jaminan_keluarga'] ?? ''; ?>";
        if (jumlahLainnyaText) {
            document.getElementById('jumlahLainnyaText').value = jumlahLainnyaText;
            document.getElementById('jumlahLainnya').value = jumlahLainnyaText;
            document.getElementById('jumlahLainnya').checked = true;
        }

        const sumberAirLainnyaText = "<?php echo $_SESSION['sumber_air_keluarga'] ?? ''; ?>";
        if (sumberAirLainnyaText) {
            document.getElementById('sumberAirLainnyaText').value = sumberAirLainnyaText;
            document.getElementById('sumberAirLainnya').value = sumberAirLainnyaText;
            document.getElementById('sumberAirLainnya').checked = true;
        }

        const up2kLainnyaText = "<?php echo $_SESSION['aktifitas_up2k'] ?? ''; ?>";
        if (up2kLainnyaText) {
            document.getElementById('up2k_lainnyaText').value = up2kLainnyaText;
            document.getElementById('up2k_lainnya').value = up2kLainnyaText;
            document.getElementById('up2k_lainnya').checked = true;
        }
    });
    </script>
