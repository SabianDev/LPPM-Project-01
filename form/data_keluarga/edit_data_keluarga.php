                ...
                <div class="modal-body" style="max-height: 400px; overflow-y: auto;">
                    <div id="modalDataContent">
                        ...
                        <div>
                            ...
                            <label>RW:</label> 
                            <input type="text" id="modalRW" class="form-control mb-3" readonly>
                            
                            <label>RT:</label> 
                            <input type="text" id="modalRT" class="form-control mb-3" readonly>
                            
                            <label>Dasa Wisma:</label> 
                            <input type="text" id="modalDasaWisma" class="form-control mb-3" readonly>
                            
                            <label>Nama Kepala Rumah Tangga:</label> 
                            <input type="text" id="modalNamaKepala" class="form-control mb-3" readonly>
                            
                            <label>No Reg:</label> 
                            <input type="text" id="modalNoReg" class="form-control mb-3" readonly>
                            
                            <label>Nama Anggota Keluarga:</label> 
                            <input type="text" id="modalNamaAnggota" class="form-control mb-3" readonly>
                            
                            <label>Status Dalam Keluarga:</label> 
                            <input type="text" id="modalStatusKeluarga" class="form-control mb-3" readonly>
                            
                            <label>Status Dalam Perkawinan:</label> 
                            ...
                            <input type="text" id="modalPendidikanTerakhir" class="form-control mb-3" readonly>
                            
                            <label>Pekerjaan:</label> 
                            <input type="text" id="modalPekerjaan" class="form-control mb-3" readonly>
                            
                            <label>Kelompok Umur:</label> 
                            <input type="text" id="modalKelompokUmur" class="form-control mb-3" readonly>
                            
                            <label>Bumil:</label> 
                            <input type="text" id="modalBumil" class="form-control mb-3" readonly>
                            
                            <label>Ibu Menyusui:</label> 
                            <input type="text" id="modalIbuMenyusui" class="form-control mb-3" readonly>
                            
                            <label>Pasangan Subur:</label> 
                            <input type="text" id="modalPasanganSubur" class="form-control mb-3" readonly>
                            
                            <label>Wanita Usia Subur:</label> 
                            <input type="text" id="modalWanitaUsiaSubur" class="form-control mb-3" readonly>
                            
                            <label>Apa 3 Buta:</label> 
                            <input type="text" id="modalApa3Buta" class="form-control mb-3" readonly>
                            
                            <label>Makanan Pokok Sehari-hari:</label> 
                            <input type="text" id="modalMakananPokok" class="form-control mb-3" readonly>
                            
                            <label>Mempunyai Jaminan Keluarga:</label> 
                            <input type="text" id="modalJaminanKeluarga" class="form-control mb-3" readonly>
                            
                            <label>Jumlah Jaminan Keluarga:</label> 
                            <input type="text" id="modalJumlahJaminan" class="form-control mb-3" readonly>
                            ...
                            <input type="text" id="modalTempatPembuangan" class="form-control mb-3" readonly>
                            
                            <label>Memiliki Saluran Pembuangan Air Limbah:</label> 
                            <input type="text" id="modalSaluranPembuangan" class="form-control mb-3" readonly>
                            
                            <label>Menempel Stiker P4K:</label> 
                            <input type="text" id="modalStikerP4K" class="form-control mb-3" readonly>
                            ...
                            <input type="text" id="modalAktifitasUP2K" class="form-control mb-3" readonly> 
                            
                            <label>Aktifitas Usaha Kesling:</label> 
                            <input type="text" id="modalAktifitasUsahaKesling" class="form-control mb-3" readonly>
