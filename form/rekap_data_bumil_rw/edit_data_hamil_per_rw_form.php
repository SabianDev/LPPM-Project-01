...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM form_rekap_bumil_rw WHERE id = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $_SESSION['rw'] = $row['kelompok_pkk_rw'];
        $_SESSION['tahun'] = $row['tahun'];
        $_SESSION['kelompok'] = $row['nama_kelompok_dasawisma'];
        $_SESSION['hamil'] = $row['hamil'];
        $_SESSION['melahirkan'] = $row['melahirkan'];
        $_SESSION['nifas'] = $row['nifas'];
        $_SESSION['meninggal'] = $row['meninggal'];
        $_SESSION['lahir_laki_laki'] = $row['lahir_laki_laki'];
        $_SESSION['lahir_perempuan'] = $row['lahir_perempuan'];
        $_SESSION['memiliki_akte_kelahiran'] = $row['memiliki_akte_kelahiran'];
        $_SESSION['tidak_memiliki_akte_kelahiran'] = $row['tidak_memiliki_akte_kelahiran'];
        $_SESSION['meninggal_laki_laki_bayi'] = $row['meninggal_laki_laki_bayi'];
        $_SESSION['meninggal_perempuan_bayi'] = $row['meninggal_perempuan_bayi'];
        $_SESSION['meninggal_laki_laki_balita'] = $row['meninggal_laki_laki_balita'];
        $_SESSION['meninggal_perempuan_balita'] = $row['meninggal_perempuan_balita'];
        $_SESSION['keterangan'] = $row['keterangan'];

        // Simpan id untuk proses update
        $_SESSION['edit_id'] = $id;
    } else {
        echo "<script>alert('Data tidak ditemukan'); window.location.href='edit_data_hamil_per_rw_form.php';</script>";
        exit();
    }
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$allFilled) {
        ...
        $id = $_SESSION['edit_id']; // Mengambil ID dari sesi untuk update

        // Koneksi ke database
        include('../connect.php');

        // Query untuk meng-update data berdasarkan ID
        $sql = "UPDATE form_rekap_bumil_rw 
                SET kelurahan = ?, kelompok_pkk_rw = ?, tahun = ?, nama_kelompok_dasawisma = ?, 
                    hamil = ?, melahirkan = ?, nifas = ?, meninggal = ?, lahir_laki_laki = ?, 
                    lahir_perempuan = ?, memiliki_akte_kelahiran = ?, tidak_memiliki_akte_kelahiran = ?, 
                    meninggal_laki_laki_bayi = ?, meninggal_perempuan_bayi = ?, 
                    meninggal_laki_laki_balita = ?, meninggal_perempuan_balita = ?, keterangan = ? 
                WHERE id = ?";

        $stmt = $conn->prepare($sql);
        $stmt->bind_param("sssssiiiiiiiiiiisi", 
            $kelurahan, $kelompok_pkk_rw, $tahun, $nama_kelompok_dasawisma, 
            $hamil, $melahirkan, $nifas, $meninggal, $lahir_laki_laki, 
            $lahir_perempuan, $memiliki_akte_kelahiran, $tidak_memiliki_akte_kelahiran, 
            $meninggal_laki_laki_bayi, $meninggal_perempuan_bayi, 
            $meninggal_laki_laki_balita, $meninggal_perempuan_balita, 
            $keterangan, $id);
...
<body class="bg-light">
    ...
    <div class="main-content mt-6">
        <div class="ctn-nav">
            ...
            <a href="edit_data_hamil_per_rw.php" class="btn btn-secondary btn-nav-kembali">Kembali</a>
        </div>
    
        <div class="master-form-container">
            <div class="form-title">
                <h2>EDIT : FORM DATA HAMIL PER RW</h2>
                ...
                <div class="ctn-form form-section" id="<?php echo $formTarget2; ?>">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="hamil" name="hamil" placeholder="Jawaban Anda">
                        </div>
                        <div class="col-md-12">
                            <label for="melahirkan" class="form-label bold">Melahirkan</label>
                            <input type="text" class="form-control" id="melahirkan" name="melahirkan" placeholder="Jawaban Anda">
                        </div>
                        <div class="col-md-12">
                            <label for="nifas" class="form-label bold">Nifas</label>
                            <input type="text" class="form-control" id="nifas" name="nifas" placeholder="Jawaban Anda">
                        </div>
                        <div class="col-md-12">
                            <label for="ibuMeninggal" class="form-label bold">Meninggal</label>
                            <input type="text" class="form-control" id="ibuMeninggal" name="ibuMeninggal" placeholder="Jawaban Anda">
                        </div>
                    </div>
                    <div class="ctn-form-button">
                ...
                <div class="ctn-form form-section" id="<?php echo $formTarget3; ?>">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="lahirLaki" name="lahirLaki" placeholder="Jawaban Anda">
                        </div>
                        <div class="col-md-12">
                            <label for="lahirPerempuan" class="form-label bold">Lahir Perempuan</label>
                            <input type="text" class="form-control" id="lahirPerempuan" name="lahirPerempuan" placeholder="Jawaban Anda">
                        </div>
                        <div class="col-md-12">
                            <label for="akteAda" class="form-label bold">Memiliki Akte Kelahiran</label>
                            <input type="text" class="form-control" id="akteAda" name="akteAda" placeholder="Jawaban Anda">
                        </div>
                        <div class="col-md-12">
                            <label for="akteTidakAda" class="form-label bold">Tidak Memiliki Akte Kelahiran</label>
                            <input type="text" class="form-control" id="akteTidakAda" name="akteTidakAda" placeholder="Jawaban Anda">
                        </div>
                        <div class="col-md-12">
                            <label for="bayiMeninggalLaki" class="form-label bold">Meninggal Laki-Laki</label>
                            <input type="text" class="form-control" id="bayiMeninggalLaki" name="bayiMeninggalLaki" placeholder="Jawaban Anda">
                        </div>
                        <div class="col-md-12">
                            <label for="bayiMeninggalPerempuan" class="form-label bold">Meninggal Perempuan</label>
                            <input type="text" class="form-control" id="bayiMeninggalPerempuan" name="bayiMeninggalPerempuan" placeholder="Jawaban Anda">
                        </div>
                    </div>
                    <div class="ctn-form-button">
                        <button type="button" class="btn btn-secondary back">Kembali</button>
                ...
                <div class="ctn-form form-section" id="<?php echo $formTarget4; ?>">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="balitaMeninggalLaki" name="balitaMeninggalLaki" placeholder="Jawaban Anda">
                        </div>
                        <div class="col-md-12">
                            <label for="balitaMeninggalPerempuan" class="form-label bold">Meninggal Perempuan</label>
                            <input type="text" class="form-control" id="balitaMeninggalPerempuan" name="balitaMeninggalPerempuan" placeholder="Jawaban Anda">
                        </div>
                    </div>
                    <div class="ctn-form-button">
                        <button type="button" class="btn btn-secondary back">Kembali</button>
    ...
    <!-- Buat ngatur navigasi back dan next -->
    <script>
    ...
    <script>
        ...
        document.getElementById("kelompok").value = "<?php echo $_SESSION['kelompok'] ?? ''; ?>";
        document.getElementById("hamil").value = "<?php echo $_SESSION['hamil'] ?? ''; ?>";
        document.getElementById("melahirkan").value = "<?php echo $_SESSION['melahirkan'] ?? ''; ?>";
        document.getElementById("nifas").value = "<?php echo $_SESSION['nifas'] ?? ''; ?>";
        document.getElementById("ibuMeninggal").value = "<?php echo $_SESSION['meninggal'] ?? ''; ?>";
        document.getElementById("lahirLaki").value = "<?php echo $_SESSION['lahir_laki_laki'] ?? ''; ?>";
        document.getElementById("lahirPerempuan").value = "<?php echo $_SESSION['lahir_perempuan'] ?? ''; ?>";
        document.getElementById("akteAda").value = "<?php echo $_SESSION['memiliki_akte_kelahiran'] ?? ''; ?>";
        document.getElementById("akteTidakAda").value = "<?php echo $_SESSION['tidak_memiliki_akte_kelahiran'] ?? ''; ?>";
        document.getElementById("bayiMeninggalLaki").value = "<?php echo $_SESSION['meninggal_laki_laki_bayi'] ?? ''; ?>";
        document.getElementById("bayiMeninggalPerempuan").value = "<?php echo $_SESSION['meninggal_perempuan_bayi'] ?? ''; ?>";
        document.getElementById("balitaMeninggalLaki").value = "<?php echo $_SESSION['meninggal_laki_laki_balita'] ?? ''; ?>";
        document.getElementById("balitaMeninggalPerempuan").value = "<?php echo $_SESSION['meninggal_perempuan_balita'] ?? ''; ?>";
    ...
    <?php if (isset($_SESSION['success_message'])): ?>
        ...
        <script>
            ...
            document.getElementById('closeModal').addEventListener('click', function() {
                window.location.href = 'edit_data_hamil_per_rw.php'; // Ganti dengan URL yang sesuai
            });
        </script>
