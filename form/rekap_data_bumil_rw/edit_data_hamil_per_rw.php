...
<head>
    ...
    <title>EDIT : REKAP DATA IBU HAMIL PER RW</title>
...
<body>
    ...
    <header class="header">
        <div class="header-left">
            <h3>EDIT : REKAP DATA IBU HAMIL PER RW</h3>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="tbl-item-button">
                                        ...
                                        <a class="a-link" href="edit_data_hamil_per_rw_form.php?id=<?= $row['id']; ?>">
                                            <button type="button" class="btn btn-light btn-custom1">
    ...
    function showData(id) {
        ...
        $.ajax({
            url: 'edit_data_hamil_per_rw_fetch.php', // Fetch data based on ID
            type: 'GET',
            data: { id: id },
