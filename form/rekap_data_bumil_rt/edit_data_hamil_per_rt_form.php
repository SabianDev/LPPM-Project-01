...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM form_rekap_bumil_rt WHERE id = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $_SESSION['kelompok_pkk_dasawisma'] = $row['kelompok_pkk_dasawisma'];
        ...
        echo "<script>alert('Data tidak ditemukan'); window.location.href='edit_data_hamil_per_rt_form.php';</script>";
        exit();
    }
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$allFilled) {
        ...
        $sql = "UPDATE form_rekap_bumil_rt 
                SET kelurahan = ?, kelompok_pkk_rw = ?, kelompok_pkk_rw = ?, tahun = ?, bulan =?, kelompok_pkk_dasawisma = ?, 
                    hamil = ?, melahirkan = ?, nifas = ?, meninggal = ?, lahir_laki_laki = ?, 
                    lahir_perempuan = ?, memiliki_akte_kelahiran = ?, 
        ...
        $stmt->bind_param("sssssssssssssssssss", 
            $kelurahan, $kelompok_pkk_rw, $kelompok_pkk_rt, $tahun, $bulan, $kelompok_pkk_dasawisma, 
            $hamil, $melahirkan, $nifas, $meninggal, $lahir_laki_laki, 
            $lahir_perempuan, $memiliki_akte_kelahiran, 
            $meninggal_laki_laki_bayi, $meninggal_perempuan_bayi, 
...
<body class="bg-light">
    ...
    <div class="main-content mt-6">
        <div class="ctn-nav">
            ...
            <a href="edit_data_hamil_per_rt.php" class="btn btn-secondary btn-nav-kembali">Kembali</a>
        </div>
    
        <div class="master-form-container">
            <div class="form-title">
                <h2>EDIT : FORM DATA HAMIL PER RT</h2>
    ...
    <script>
        ...
        document.getElementById("rw").value = "<?php echo $_SESSION['kelompok_pkk_rw'] ?? ''; ?>";
        document.getElementById("rt").value = "<?php echo $_SESSION['kelompok_pkk_rt'] ?? ''; ?>";
        document.getElementById("tahun").value = "<?php echo $_SESSION['tahun'] ?? ''; ?>";
        document.getElementById("bulan").value = "<?php echo $_SESSION['bulan'] ?? ''; ?>";
        document.getElementById("kelompok").value = "<?php echo $_SESSION['kelompok_pkk_dasawisma'] ?? ''; ?>";
    ...
    <?php if (isset($_SESSION['success_message'])): ?>
        ...
        <script>
            ...
            document.getElementById('closeModal').addEventListener('click', function() {
                window.location.href = 'edit_data_hamil_per_rt.php'; // Ganti dengan URL yang sesuai
            });
        </script>
